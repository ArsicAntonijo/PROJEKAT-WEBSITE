 <?php
  ...
  //variable correct 0 if everything is oke, 1 otherwise
  $correct1 = $correct2 = $correct3 = $correct4 = $correct5 = 0;
  $check1 = $check2 = $check3 = 0;

  // accepting info for LOGGING IN--------------------
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (empty($_POST["email"])) {
      $emailErr = "* All fields must be filled!";
    } else {
				...
				if (empty($_POST["pass"])){
					...
					while($row = $result->fetch_assoc()) {
						if($row["password"] == $pass){						
							...
							$_SESSION["userInfo"] = $row['name'] ." ". $row['lastname'];
...
<link rel="stylesheet" type="text/css" href="stylingLogIn.css">
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
		<br><img src="exit-logo.svg" id="icon" alt="User Icon" />
    </div>

    <!-- Login Form -->
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	  <label id="err"> <?php echo $emailErr; ?>  </label><br>
      <input type="text" id="login" class="fadeIn second" name="email" placeholder="login" value="<?php echo $email; ?>">
	  <label id="err"> <?php echo $passErr; ?>  </label><br>
